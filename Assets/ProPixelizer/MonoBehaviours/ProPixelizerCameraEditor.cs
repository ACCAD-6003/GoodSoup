...
namespace ProPixelizer.Tools
{
    ...
    public class ProPixelizerCameraEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("Pixel Sizes", EditorStyles.boldLabel);
            ...
            if (snap.CannotMaintainWSPixelSize && snap.Mode == ProPixelizerCamera.PixelSizeMode.WorldSpacePixelSize)
            {
